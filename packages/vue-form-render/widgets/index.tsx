...
import { clone, convertValue, getSubSchemas, resolve, validate } from '../utils'
    ...
    return () => {
      ...
      return (
        <div class="form-item object">
          {props.schema.title && <div class="title">{props.schema.title}</div>}
          <div class="content">
            {
            ...
            props.schema.title && (
              <div class="title">
                ...
                <div class="flex align-center">
                  ...
                  <span class="upload-excel" onClick={exportExcel}>下载 excel</span>
                  {props.schema.maxLength && props.schema.maxLength <= props.value.length
                    ? null
                    : (
                        <PlusOutlined
                          onClick={() => {
                    ...
                    <a-collapse>
                      <a-collapse-panel
                        ...
                        v-slots={{
                          ...
                          extra: () => (
                            props.schema.minLength && props.schema.minLength >= props.value.length
                              ? null
                              : (
                                  <DeleteOutlined
                                    onClick={() => {
