...
<template>
  <DialogPortal>
    ...
    >
      ...
      <DialogClose
        class="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity disabled:pointer-events-none hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground"
      >
        <X class="h-8 w-8" />
