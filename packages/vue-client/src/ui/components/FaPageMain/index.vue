...
<template>
  ...
  >
    ...
    >
      <slot />
      <FaButton v-if="collaspe" variant="link" size="icon" class="absolute transition-all -translate-x-1/2 inset-b-0 inset-s-1/2 opacity-0 group-hover/pagemain:opacity-100" :class="{ 'rotate-x-180': !isCollaspe }" @click="handleCollaspe">
