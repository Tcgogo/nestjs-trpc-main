...
import { TRPCErrorFormatter, TRPCRootConfig } from "@trpc/server";
import { Class } from "type-fest";
import { ZodType } from "zod";

//#region lib/interfaces/module-options.interface.d.ts
type SchemaImports = ((...args: Array<unknown>) => unknown) | object | ZodType;
/**
...
//#endregion
export { SchemaImports, TRPCModuleOptions };
//# sourceMappingURL=module-options.interface-DeOL6Qt8.d.ts.map