...
//#region lib/decorators/middlewares.decorator.d.ts
 ...
 * @publicApi
 */
declare function UseMiddlewares(...middlewares: Array<Class<TRPCMiddleware> | Constructor<TRPCMiddleware>>): MethodDecorator & ClassDecorator;
/**
 ...
 * @publicApi
 */
declare function Middlewares(...middlewares: Array<Class<TRPCMiddleware> | Constructor<TRPCMiddleware>>): MethodDecorator & ClassDecorator;
//# sourceMappingURL=middlewares.decorator.d.ts.map

//#endregion
export { Middlewares, UseMiddlewares };
//# sourceMappingURL=middlewares.decorator-DYLXN44f.d.ts.map